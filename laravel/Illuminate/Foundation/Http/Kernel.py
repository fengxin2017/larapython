...
class Kernel():
    Bootstrappers = [
        'laravel.Illuminate.Foundation.Bootstrap.LoadConfiguration',
        'laravel.Illuminate.Foundation.Bootstrap.RegisterProviders',
        'laravel.Illuminate.Foundation.Bootstrap.BootProviders'
    ]
